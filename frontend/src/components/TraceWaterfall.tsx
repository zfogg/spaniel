...
// Drift-aligned span palette — sky, sage, amber, lavender, slate, mint, sand…
const PALETTE = [
...
function flatten(spans: Span[]): FlatSpan[] {
...
function buildTagMap(warnings: LintWarning[]): Map<string, string> {
